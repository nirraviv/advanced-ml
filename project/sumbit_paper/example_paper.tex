...
\icmltitlerunning{Generation of Singing Voice using Genreative Adverserial Networks}

\begin{document}

\twocolumn[
\icmltitle{Generation of Singing Voice using Genreative Adverserial Networks \\
...
\icmlcorrespondingauthor{Nir Raviv}{nirraviv@post.tau.ac.il}
\icmlcorrespondingauthor{Roi Tabach}{roitabac@post.tau.ac.il}
\icmlcorrespondingauthor{Andrey Leshchenko}{XXXXX@post.tau.ac.il}


% You may provide any keywords that you
% find helpful for describing your paper; these are used to populate
% the "keywords" metadata in the PDF but will not be shown in the document
\icmlkeywords{Machine Learning, GAN, Generative Adverserial Networks, Singing Voice Generation}
...
\begin{abstract}
In 2016, XXX presented their new WaveNet network. Since than, there have been massive work in the area of Text to Speech and Speech to Text. We wish to generate audio as well- but not speech but singing voice. We mainly used the DAMP dataset , and have not completed the task to our satisfaction.
\end{abstract}
...
%TODO in here
All submissiqons must follow the specified format.
